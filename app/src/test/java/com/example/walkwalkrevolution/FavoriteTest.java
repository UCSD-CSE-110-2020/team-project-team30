...
public class FavoriteTest {
    ...
    public void favoriteFragmentWasCreated(){
        assertEquals(false, favoriteFrag == null);
    }

    @Test
    public void noStarClicked(){
    ...
    public void clickedFilledStar(){
        ...
        FavoriteFragment updatedFragment =
                (FavoriteFragment) walkActivity.getSupportFragmentManager().findFragmentByTag("FAVORITE FRAG");
        assertEquals(null, updatedFragment);
    }

    @Test
    public void clickedUnFilledStar(){
        ImageView unfilledStar = favoriteFrag.getView().findViewById(R.id.imageView_star_unfilled);
        unfilledStar.performClick();
